 ...
 * 2020-02-27T11:25:20.157+01:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "AccountService",
                  wsdlLocation = "file:/Users/benedikt/PAG/boot-cxf-soap-demo/src/main/resources/wsdl/Accounts.wsdl",
                  targetNamespace = "http://www.briansdevblog.com/Accounts/")
public class AccountService_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.briansdevblog.com/Accounts/", "AccountService");
    public final static QName AccountsPort = new QName("http://www.briansdevblog.com/Accounts/", "AccountsPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/benedikt/PAG/boot-cxf-soap-demo/src/main/resources/wsdl/Accounts.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/benedikt/PAG/boot-cxf-soap-demo/src/main/resources/wsdl/Accounts.wsdl");
        }
        WSDL_LOCATION = url;
    }
